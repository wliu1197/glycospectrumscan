...
public final class GenerateImage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	LinkedList <NewMass_GS> gs_NM=(LinkedList <NewMass_GS>)request.getSession().getAttribute("gs_NM");
      ...
      out.write("\t\t\t\t<h3>Upload by Text file</h3>\r\n");
      ...
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tSelected for Sequence:\r\n");
 ...
 for(int i=0; i<gs_NM.size(); i++){
      ...
      out.write("\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t       \r\n");
      out.write("\t\t\t\t        <input class=\"btn btn-primary btn-medium\" type=\"submit\" value=\"Upload\" />\r\n");
      out.write("\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<h3>Upload by Mzxml</h3><br>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<form method=\"post\" action=\"UploadMzxmlServlet\" onsubmit=\"return testImportDataSet(this);\" enctype=\"multipart/form-data\">\r\n");
      out.write("\t\t\t\t        Select file to upload: <input type=\"file\" name=\"dataFile\"\r\n");
      out.write("\t\t\t\t            id=\"fileChooser\" />\r\n");
      out.write("\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\r\n");
